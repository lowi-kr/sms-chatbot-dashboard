...
// NOTE: /api/conversations/:id/messages has been intentionally removed.
// Message content is AES-256-GCM encrypted per-user in D1 and cannot be decrypted here.
...
export default {
  async fetch(request, env) {
    ...
    // Message content is encrypted with a per-user key and cannot be read server-side.
